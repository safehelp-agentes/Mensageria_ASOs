...
from src.soc.api import buscar_contatos_empresa, extrair_primeiro_numero_contato
...
def main(usar_ontem: bool = False, data_especifica: str | None = None):
        ...
        if META_ENVIAR and resultado["downloads_ok"] > 0:
            try:
                ...
                if resp_meta["enviados_ok"] > 0:
                    # Marca no Supabase os ASOs cujo download teve sucesso
                    ...
                    for reg in regs_empresa:
                        ...
                        if chave not in chaves_com_erro_dl:
                            marcar_aso_enviado(
                                ...
                                data_envio     = data_consulta,
                                data_emissao   = data_emissao,
                                numero_destino = numero_destino,
                            )

                    # Registra log de mensagens por arquivo enviado
    ...
    # ── 7. Registra volumetria no Google Sheets ───────────────────────────────
